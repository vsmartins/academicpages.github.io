...
**Martins, V. S.**, Lyapustin, A., Wang, Y., Giles, D. M., Smirnov, A., Slutsker, I., & Korkin, S. (2019). [**_Global validation of columnar water vapor derived from EOS MODIS-MAIAC algorithm against the ground-based AERONET observations_**](https://www.sciencedirect.com/science/article/pii/S0169809518315515). Atmospheric Research.
